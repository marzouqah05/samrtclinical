    ...
    public static class DbInitializer
    {
            ...
            ILogger logger)
        {
            try
            {
                ...
                // Ensure ReferralRequests table exists
                try
                {
                ...
                try
                {
                    await context.Database.ExecuteSqlRawAsync(@"
                        CREATE TABLE IF NOT EXISTS ""Notifications"" (
                            ...
                            ""ReferralRequestId"" integer NULL,
                ...
                // Ensure Specialties table and Doctor SpecialtyId exist
                try
                {
                    await context.Database.ExecuteSqlRawAsync(@"
                        ...
                        ALTER TABLE ""Doctors"" ADD COLUMN IF NOT EXISTS ""SpecialtyId"" integer NULL;");
                }
                catch { }
