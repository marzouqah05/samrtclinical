        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DepartmentAbbr = table.Column<string>(type: "varchar(10)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VendorOrPayee = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    Notes = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    ReceiptAttachmentPath = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PatientId = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    PatientNumber = table.Column<string>(type: "varchar(10)", maxLength: 10, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DoctorName = table.Column<string>(type: "varchar(150)", nullable: false),
                    ...
                    DepartmentId = table.Column<int>(type: "integer", nullable: false),
                    DoctorEmail = table.Column<string>(type: "varchar(150)", maxLength: 150, nullable: true),
                    DoctorPhone = table.Column<string>(type: "varchar(30)", maxLength: 30, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChiefComplaint = table.Column<string>(type: "varchar(500)", maxLength: 500, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TreatmentDesc = table.Column<string>(type: "varchar(200)", maxLength: 200, nullable: false),
                    TreatmentCost = table.Column<decimal>(type: "numeric(12,2)", nullable: false),
                    Diagnosis = table.Column<string>(type: "text", nullable: true),
                    PrescriptionNotes = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PatientAttachments_MedicalRecords_MedicalRecordId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PatientAttachments_MedicalRecordId",
