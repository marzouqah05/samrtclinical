...
namespace WebApplication1.Migrations
{
    ...
    [Migration("20260913200409_AddTelegramChatIdToPatient")]
    partial class AddTelegramChatIdToPatient
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApplication1.Models.Appointment", b =>
                {
                    ...
                    b.Property<bool>("IsOutsideHoursException")
                        .HasColumnType("boolean");
                    ...
                    b.Property<int?>("ReferredByDoctorId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("WebApplication1.Models.ReferralRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("WebApplication1.Models.Appointment", b =>
                {
                    ...
                    b.HasOne("WebApplication1.Models.Doctor", "ReferredByDoctor")
                        .WithMany()
            ...
            modelBuilder.Entity("WebApplication1.Models.Notification", b =>
                {
                    ...
                    b.HasOne("WebApplication1.Models.ReferralRequest", "ReferralRequest")
                        .WithMany()
            ...
            modelBuilder.Entity("WebApplication1.Models.ReferralRequest", b =>
                {
                    b.HasOne("WebApplication1.Models.Doctor", "FromDoctor")
                        .WithMany()
                    ...
                    b.HasOne("WebApplication1.Models.Department", "TargetDepartment")
                        .WithMany()
                        .HasForeignKey("TargetDepartmentId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("WebApplication1.Models.Doctor", "TargetDoctor")
                        .WithMany()
